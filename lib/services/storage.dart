...
class Storage extends Service {
  ...
  /// Get Url File
  ///
  /// Get the [URL] of a file from bucketId and fileId.
  /// Check the bucket roles permissions to get URL.
  /// Protected buckets get unauthorized permissions (401).
  ///
  Uri getUrlFile({required String bucketId, required String fileId}) {
    final String path =
